...
import (
	...
	webHandler "bwastartup/webAdmin/handler"
...
func main() {
	...
	transactionServie := transaction.NewService(transactionRepository, campaignRepository, paymentService)

	//Get Handler Module
	userHandler := handler.NewUserHandler(userService, authService)
	campaignHandler := handler.NewCampaignHandler(campaignService)
	transactionHandler := handler.NewTransactionHandler(transactionServie)
	...
	//load template admin cms
	router.HTMLRender = loadTemplates("./webAdmin/templates")

	router.Static("/images", "./images")
	router.Static("/css", "./webAdmin/assets/css")
	router.Static("/js", "./webAdmin/assets/js")
	router.Static("/webfonts", "./webAdmin/assets/webfonts")
	...
	router.POST("/users/updates/:id", authAdminMiddleware(), userWebHandler.Update)
	router.GET("/users/avatars/:id", authAdminMiddleware(), userWebHandler.NewAvatar)
	router.POST("/users/avatars/:id", authAdminMiddleware(), userWebHandler.CreateAvatar)
