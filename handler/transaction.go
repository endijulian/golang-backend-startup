...
func (h *transactionHandler) GetUserTransactions(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Failed get users transactions", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
	}
...
func (h *transactionHandler) CreateTransaction(c *gin.Context) {
	...
	response := helper.APIResponse("Transactions", http.StatusOK, "success", transaction.FormatTransaction(newTransaction))
	c.JSON(http.StatusOK, response)
